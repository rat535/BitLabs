...
public class Users {
	...
	public Users(Long id, String name, String email, String whatsapp, Qualifaction qualification, String specialization,
			int totalExperience, Set<PefferedLocation> preferdJobLocation, Address address, Date dateOfBirth,
			Set<Skills> skills, String profileImage, String resume, Set<CompanyJob> appliedJobs) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
